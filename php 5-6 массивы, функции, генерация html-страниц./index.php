 ...
 * @var array $latestPost
 * string num 331
 */
$latestPost = [
    [
        'imgCard' => 'images/img_5.jpg',
        'imgAltCard' => 'Image placeholder',
        'imgAuthor' => 'images/person_1.jpg',
        'author' => 'Colorlib',
        'imgAltAuthor' => 'Colorlib',
        'datePosts' => 'March 15, 2018',
        'numberOfComments' => '3',
        'namePosts' => 'How to Find the Video Games of Your Youth',
        'pagePost' => 'blog-single.html',
    ],
    [
        'imgCard' => 'images/img_6.jpg',
        'imgAltCard' => 'Image placeholder',
        'imgAuthor' => 'images/person_1.jpg',
        'author' => 'Colorlib',
        'imgAltAuthor' => 'Colorlib',
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    <div class="row">
                        ...
                        <?php foreach ($latestPost as $post): ?>
                            <?php
                            /**
                             * Деструктуризация данных поста
                             * Создаем отдельные переменные для каждого поля
                             *
                             * imgCard - основное изображение карточки поста
                             * imgAltCard - alt текст для основного изображения
                             * imgAuthor - аватар автора поста
                             * author - имя автора поста
                             * imgAltAuthor - alt текст для аватара автора
                             * datePosts - дата публикации поста
                             * numberOfComments - количество комментариев к посту
                             * namePosts - название поста
                             * pagePost - ссылка на страницу поста
                             */
                            [
                                'imgCard' => $imgCard,
                                'imgAltCard' => $imgAltCard,
                                'imgAuthor' => $imgAuthor,
                                'author' => $author,
                                'imgAltAuthor' => $imgAltAuthor,
                                'datePosts' => $datePosts,
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-5">
                                ...
                                <ul class="list-unstyled footer-social">
                                    ...
                                    <li>
                                        <a href="#"
                                        ><span class="fa fa-snapchat"></span> Snapshot</a
                                        >
                                    </li>
                                </ul>
                            </div>
